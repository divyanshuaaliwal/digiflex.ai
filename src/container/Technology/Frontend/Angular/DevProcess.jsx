...
export default function AngularDevelopmentProcess() {
  const steps = [
    { 
      ...
      description: "Understand project needs and goals through detailed stakeholder consultation.",
      icon: FileSearch,
      color: "text-purple-600"
    },
    { 
      title: "Design & Prototyping", 
      description: "Create wireframes and UI/UX design with modern design principles.",
      icon: Paintbrush,
      color: "text-pink-600"
    },
    { 
      title: "Development", 
      description: "Code using Angular framework and best practices for scalable applications.",
      icon: Code2,
      color: "text-blue-600"
    },
    { 
      title: "Testing & QA", 
      description: "Ensure quality with comprehensive automated and manual testing protocols.",
      icon: FlaskConical,
      color: "text-green-600"
    },
    { 
      title: "Deployment", 
      description: "Deploy the application to production environments with CI/CD pipelines.",
      icon: Rocket,
      color: "text-orange-600"
    },
    { 
      title: "Maintenance & Updates", 
      description: "Monitor performance and implement continuous improvements post-launch.",
      icon: Settings,
      color: "text-teal-600"
    },
  ];
