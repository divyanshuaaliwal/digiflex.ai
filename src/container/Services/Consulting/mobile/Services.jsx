...
const services = [
  {
    ...
    description: "At Digiflex.ai, we transform your vision into reality. Our mobile app launch services include:",
    items: [
      "Crafting a clear product vision and strategy",
      "Creating a functional prototype",
      "Developing a detailed plan and specifications"
    ],
    footer: "From ideation to execution, we ensure your app is ready to succeed in today's competitive market."      
  },
  {
    icon: <Search className="w-8 h-8" />,
    title: "Comprehensive Mobile App Audit",
    description: "Our team of experts at Digiflex.ai performs a thorough health check of your mobile app, covering:",
    items: [
    ...
    footer: "We'll help you identify areas of improvement and maximize your app's potential.",
  },
  {
    icon: <Settings className="w-8 h-8" />,
    title: "Mobile App Modernization Services",
    description: "Revitalize your mobile app with Digiflex.ai's consulting expertise. Our app modernization process includes:",
    items: [
    ...
    footer: "Let's bring your app up to speed with the latest trends and technologies.",
  }
];
