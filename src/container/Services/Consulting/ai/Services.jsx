  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-5xl font-bold mb-4 text-blue-800 text-center">Here's what you get from our</h2>
        ...
        <p className="text-lg text-gray-600 mb-12 max-w-7xl text-center">
          Partner with Digiflex.ai, a trusted AI consulting company, to harness cutting-edge AI solutions that enhance customer experiences and drive business success.
        </p>
