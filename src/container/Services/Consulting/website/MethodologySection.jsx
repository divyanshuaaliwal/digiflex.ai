...
const MethodologySection = () => {
  ...
  const methodologyDetails = {
    'UX-BASED WEB DESIGN': {
      description: 'At Digiflex.ai, we prioritize user-centric design to create seamless, intuitive navigation and engaging interfaces that enhance user satisfaction.',
    ...
    'DATA-DRIVEN DECISIONS': {
      description: 'Digiflex.ai empowers businesses to make informed design and strategic decisions using advanced analytics and user behavior insights.',
    ...
    'SEO CONTENT': {
      description: 'We craft strategically optimized content that ranks high on search engines while delivering genuine value to users.',
    ...
    'ONGOING OPTIMIZATION': {
      description: 'Stay ahead of the competition with continuous monitoring and iterative improvements for top-notch performance and user experience.',
  ...
  return (
    <section className="py-16 bg-gray-100">
      <div className="container mx-auto px-4 ">
        <h2 className="text-3xl font-bold text-center mb-2 text-blue-900">Our Web Consultants' Best Practices</h2>
          ...
          {Object.keys(methodologyDetails).map((item, index) => (
            <motion.div 
              ...
              className={`relative p-6 rounded-lg cursor-pointer transition-all duration-300 
                ${activeItem === item 
                  ? 'bg-blue-700 text-white z-20 shadow-2xl scale-105' 
