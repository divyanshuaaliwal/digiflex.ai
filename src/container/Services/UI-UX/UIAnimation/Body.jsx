...
function Body() {
  return (
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-12">
          ...
          <div className="lg:w-2/5 flex flex-col gap-6">
            ...
            <button className="bg-blue-900 hover:bg-blue-600 transition-colors text-white px-8 py-3 rounded w-fit">
    ...
    <div className="bg-white w-full p-4 sm:p-6 md:p-8 lg:p-16">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 lg:gap-12">
        ...
        <div className="flex flex-col gap-6 w-full lg:w-1/3">
          ...
          {/* Description */}
          <p className="text-[#2D3648] text-base sm:text-lg leading-relaxed">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col gap-6 mb-16">
          <h1 className="text-3xl sm:text-4xl md:text-5xl  text-blue-950 font-bold">
            Our Approach as a Leading UI & Animation Design Company</h1>
          <p className="text-black text-lg max-w-4xl">
          ...
          {approaches.map((approach) => (
            ...
            >
              <div className="flex flex-col gap-4">
                ...
                {/* Content */}
                <h3 className="text-xl font-semibold text-black">{approach.title}</h3>
                <p className="text-black leading-relaxed">{approach.description}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-6 md:gap-8">
          {tools.map((tool, index) => (
            <div
              key={index}
              className="flex flex-col   items-center w-[240px] bg-white rounded-lg p-8 shadow-lg hover:scale-105 hover:shadow-lg hover:shadow-blue-300 transition-shadow duration-300"
            >
              {/* Icon */}
              {tool.icon}
    ...
    {/*Section 6*/}
    <div className="min-h-screen bg-gray-50/80 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-blue-950 mb-4">Benefits of UI/UX Design</h2>
        ...
        <div className="flex flex-col md:flex-row gap-8 justify-center items-stretch">
          {benefits.map((benefit) => (
            <div
              key={benefit.id}
              className={`group flex-1 min-w-[280px] max-w-md bg-white rounded-xl p-8
