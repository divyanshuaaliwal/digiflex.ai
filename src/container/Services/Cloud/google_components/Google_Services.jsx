    ...
    <>
      <WrapperContainer>
        <div>
          ...
          <p className=" text-center mb-10 text-gray-600 text-[20px]">
              ...
              {steps.map((step, index) => (
                <React.Fragment key={step.id}>
                  <div className="flex flex-col items-center relative z-10">
                    <div
                      className={`${step.color} w-24 h-24 rounded-full flex items-center justify-center text-white font-medium p-4`}
                    >
                      <span className="text-center text-sm">{step.name}</span>
                    </div>
                  </div>
                  {index < steps.length - 1 && (
                    <div className="flex-1 h-1 bg-gray-400 mx-2 relative z-0"></div>
                  )}
                </React.Fragment>
              ))}
            </div>
        ...
        <div className="ml-20 mr-20 mt-[100px]">
          <Heading>
