...
export const StandOut = () => {
  const strategies = [
    ...
    },
    {
      ...
      description:
        "Innovation never stops. We help you adapt and evolve with the latest trends to stay ahead in the digital landscape.",
    },
  ];
    ...
    <WrapperContainer>
      <div className="h-full bg-white text-black overflow-hidden">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-12">
          ...
          <header className="text-center max-w-3xl mx-auto pb-6 sm:pb-8">
            <h1 className="text-2xl sm:text-4xl lg:text-5xl font-bold tracking-tight">
              ...
              <span className="relative text-blue-700">
                SUCCESS
                <span className="absolute -right-4 text-blue-700">.</span>
              </span>
            </h1>
              ...
              >
                <div className="p-4">
                  ...
                  >
                    ...
                    <button
                      className="mt-4 py-2 px-4 bg-blue-700 text-white rounded-xl
                        hover:bg-blue-500 text-sm font-semibold
          ...
          {/* Tablet and Desktop View (≥ 640px) */}
          <div className="hidden sm:flex justify-center gap-3 lg:gap-6 pb-2 flex-wrap">
            {strategies.map((strategy, index) => (
              <div
                key={strategy.number}
                ...
                className={`relative rounded-3xl transition-all duration-500 ease-in-out cursor-pointer
                  ...
                  h-[320px] md:h-[380px] lg:h-[400px] flex-shrink-0
              ...
              >
                ...
                <div className="absolute inset-0 p-4 md:p-6 lg:p-8 flex flex-col transition-all duration-500 ease-in-out">
                  <div className="h-full flex flex-col justify-between">
                    ...
                    <h3
                      className={`text-lg md:text-xl lg:text-2xl font-bold text-gray-900 transition-all duration-500 ease-in-out
                      ${
                        hoverIndex === index || activeIndex === index
                          ? "rotate-0"
                          : "-rotate-90 origin-[0%_50%] translate-x-8"
                      }
                      whitespace-nowrap`}
                    >
                      {strategy.title}
                ...
                {/* Hover/Active state content */}
                <div
                  className={`absolute inset-0 p-4 md:p-6 lg:p-8 bg-white rounded-3xl shadow-xl
                ...
                >
                  <div className="flex flex-col h-full">
                    <span className="text-blue-500 font-semibold transition-all duration-700 delay-150">
                      {strategy.number}
                    </span>
                    <h3 className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900 mt-2 mb-3 md:mb-4 
                    ...
                    <button
                      className="mt-4 py-2 px-4 bg-blue-700 text-white rounded-xl
                        hover:bg-blue-500 text-sm font-semibold
                        flex items-center justify-center gap-2 transition-all duration-700 delay-500"
                      aria-label={`Learn more about ${strategy.title}`}
                    >
                      Learn More
                      <svg
